...
ลองใช้เครื่องมือจำลองสินเชื่อของเราดูครับ!`;
      ...
      response = `การออมเงินเป็นพื้นฐานสำ��ัญของการเงินที่ดีครับ 💰
...
อยากเรียนรู้เรื่องการออมเงินเพิ่มเติมไหมครับ?`;
      ...
      response = `เรามีบทเรียนที่น่าสนใจม��กมายครับ! 📚

🎯 หมวดหมู่ที่แนะนำ:
• พื้นฐานการเงิน - เริ่มต้นที่นี่
• สินเชื่อบ้าน - ความร��้เชิงลึก
• การลงทุน - สร้างความมั่งคั่ง
• วางแผนการเงิน - อนาคตที่มั่นคง

แต่ละบทเรียนใช้เวลาไม่เกิน 20 นาที และได้คะแนน���างวัลด้วยครับ!`;
...
หรือเลือกคำถามด่วนด้านล่างได้เล��ครับ!`;
      quickReplies = [
        "เครดิตคืออะไร?",
        "สินเชื่อบ้าน",
        "วิธีออมเงิน",
